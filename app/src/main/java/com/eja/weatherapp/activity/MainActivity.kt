package com.eja.weatherapp.activity
...
import com.eja.weatherapp.R
import com.eja.weatherapp.adapter.MainAdapter
import com.eja.weatherapp.fragment.FragmentNextDays
import com.eja.weatherapp.model.ModelMain
import com.eja.weatherapp.networking.ApiEndpoint
            ...
            .getAsJSONObject(object : JSONObjectRequestListener {
                override fun onResponse(response: JSONObject) {
                    try {
                        ...
                        tvTemperatur.text = String.format(Locale.getDefault(), "%.0f°C", dblTemperatur)
